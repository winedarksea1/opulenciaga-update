        ...
        <div id="navbar">
          <div id="navbarButtons">
            <ul>
              ...
              <li id='shoelaces'><a href="#"><Link to="/wines">Wines</Link></a></li>
              <li id='perfumes'><a href="#"><Link to="/perfumes">Perfumes</Link></a></li>
              <li id='ties'><a href="#"><Link to="/rings">Rings</Link></a></li>
              <li id='hats'><a href="#"><Link to="/watches">Watches</Link></a></li>
